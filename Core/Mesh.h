	...
	*/
	...
	public:
		...
		*/
		...
		const vector<XYZ> getVertices() const;
		const list<TriangleFace> getFaces() const;
		...
		*/
		bool SaveToSTLAscii(string Filename) const;

		bool SaveToSTLBinary(string Filename) const;
