...
namespace TexGen {
	...
	public:
		...
		XYZ(double setX, double setY, double setZ) {
			x = setX;
			y = setY;
			z = setZ;
		}
		...
		friend std::istream &operator >> (std::istream &input, XYZ &Vector)
		{
			input >> Vector.x;
			input.ignore(); // ignore the comma
			input >> Vector.y;
			input.ignore(); // ignore the comma
			input >> Vector.z;
			return input;
	...
	public:
		...
		friend std::istream &operator >> (std::istream &input, XY &Vector)
		{
