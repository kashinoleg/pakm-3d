...
, m_pOutliner(NULL)
{
	...
	pMenuFile->Append(ID_Open, wxT(L"&Open..."));
	pMenuFile->AppendSeparator();
	pMenuFile->Append(ID_Save, wxT(L"&Save as..."));
	pMenuFile->AppendSeparator();
	{
...
void CTexGenMainFrame::OnAbout(wxCommandEvent& WXUNUSED(event)) {
	...
	StringStream << "Version " << CTexGen::GetInstance().GetVersion() << " (Official Build) (32-bit)" << endl;
