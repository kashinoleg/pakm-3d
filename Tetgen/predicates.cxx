...
double fppow2(int n) {
	double x = (n < 0) ? ((double)1.0 / (double)2.0) : (double)2.0;
	n = (n < 0) ? -n : n;
...
double orient3dadapt(double *pa, double *pb, double *pc, double *pd, double permanent)
{
	...
	errbound = o3derrboundC * permanent + resulterrbound * fabs(det);
...
double orient3d(double *pa, double *pb, double *pc, double *pd)
{
	...
	permanent = (fabs(bdxcdy) + fabs(cdxbdy)) * fabs(adz)
...
double incircleadapt(double *pa, double *pb, double *pc, double *pd, double permanent)
{
	...
	errbound = iccerrboundC * permanent + resulterrbound * fabs(det);
...
double incircle(double *pa, double *pb, double *pc, double *pd)
{
	...
	permanent = (fabs(bdxcdy) + fabs(cdxbdy)) * alift
...
double insphereadapt(double *pa, double *pb, double *pc, double *pd, double *pe, double permanent) {
	...
	errbound = isperrboundC * permanent + resulterrbound * fabs(det);
