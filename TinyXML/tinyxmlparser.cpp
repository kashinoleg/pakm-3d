...
TiXmlEntity TiXmlBase::entity[TiXmlBase::NUM_ENTITY] =
{
	{ "&amp;",  5, '&' },
	{ "&lt;",   4, '<' },
	{ "&gt;",   4, '>' },
...
void TiXmlDocument::SetError(TiXmlError err, const char* pError, TiXmlParsingData* data, TiXmlEncoding encoding) {
