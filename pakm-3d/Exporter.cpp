...
void CExporter::TextileToIGES(string fileName, CTextile Textile, bool ExportDomain, bool SubtractYarns)
{
	TGLOGINDENT("Saving Textile to IGES file: " << fileName);
	vector<TopoDS_Solid> shapes = TextileToVector(Textile, ExportDomain, SubtractYarns);
...
void CExporter::TextileToSTEP(string fileName, CTextile Textile, bool ExportDomain, bool SubtractYarns)
{
...
void CExporter::NameTextileToIGES(string fileName, string TextileName, bool ExportDomain, bool SubtractYarns)
{
	auto textile = CTextile(*CTexGen::Instance().GetTextile(TextileName));
	thread thr(CExporter::TextileToIGES, fileName, textile, ExportDomain, SubtractYarns);
	thr.detach();
	//TextileToIGES(fileName, textile, ExportDomain, SubtractYarns);
}

void CExporter::NameTextileToSTEP(string fileName, string TextileName, bool ExportDomain, bool SubtractYarns)
{
	auto textile = CTextile(*CTexGen::Instance().GetTextile(TextileName));
	thread thr(CExporter::TextileToSTEP, fileName, textile, ExportDomain, SubtractYarns);
	thr.detach();
	//TextileToSTEP(fileName, textile, ExportDomain, SubtractYarns);
}
...
vector<TopoDS_Solid> CExporter::TextileToVector(CTextile &Textile, bool ExportDomain, bool SubtractYarns)
{
