	...
	*/
	...
	public:
		...
		*/
		...
		inline vtkRenderer * GetRenderer() { return m_pRenderer; }

		/// Get the renderer object
		inline vtkRenderWindowInteractor * GetInteractor() { return m_pRenderWindowInteractor; }
		...
		*/
		...
		inline void RemoveNodes() { RemoveProps(PROP_NODE); }
		inline void RemovePaths() { RemoveProps(PROP_PATH); }
		inline void RemoveTextiles() { RemoveProps(PROP_SURFACE); }
		inline void RemoveMeshes() { RemoveProps(PROP_VOLUME); }
		inline void RemoveAxes() { m_pOrientationMarkerWidget->SetEnabled(0); RefreshView();/*RemoveProps(PROP_AXES);*/ }
		inline void RemoveInterference() { RemoveProps(PROP_INTERFERENCE); }
		inline void RemoveInterferenceDepth() { RemoveProps(PROP_INTERFERENCE_DEPTH); }
		inline void RemoveOrientations() { RemoveProps(PROP_ORIENTATION); }
		inline void RemoveDomains() { RemoveProps(PROP_DOMAIN); }
		inline void RemoveDomainAxes() { RemoveProps(PROP_DOMAINAXES); }
		inline vtkPolyData *GetPolyData(const CMesh &Mesh);
		inline bool GetXRay() const { return m_bXRay; }
		inline bool GetTrimToDomain() const { return m_bTrimToDomain; }
